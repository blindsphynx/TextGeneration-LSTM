...
def parse_opt():
    ...
    parser.add_argument('--source-dict', default='char_to_index.json.txt', help='read char_dict from file')
...
def generate(source_dict, load_model, start):
    source = source_dict
    my_model = load_model
    start_text = start
    ...
    # def evaluate(model, char_to_idx, idx_to_char, start_text=' ', prediction_len=250, temp=0.3):
